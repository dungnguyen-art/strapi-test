...
export interface ApiI18NI18N extends Schema.CollectionType {
  ...
  attributes: {
    key: Attribute.String & Attribute.Unique;
    en: Attribute.JSON;
    vi: Attribute.JSON;
    zh: Attribute.JSON;
    ja: Attribute.JSON;
...
export interface ApiInfoInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    description: Attribute.Text;
    developers: Attribute.Component<'product.developer', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTutorialTutorial extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['video', 'text']> &
